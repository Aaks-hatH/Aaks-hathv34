  ...
  return (
    <div className="fixed inset-0 z-[10000] bg-black/90 flex flex-col items-center justify-center p-4 backdrop-blur-md">
      ...
      >
        ...
        <h2 className="text-xl font-mono text-green-500 mb-6 flex items-center justify-center gap-2"><Crown className="w-5 h-5" /> FIRST_BLOOD</h2>
        ...
        <button onClick={onClose} className="mt-8 w-full bg-green-600 hover:bg-green-500 text-black font-bold py-3 rounded uppercase tracking-widest transition-colors">
            Claim Reward & Enter
        </button>
      </motion.div>
    </div>
